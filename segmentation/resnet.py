...
class Bottleneck(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        print('=> => creates', self.__class__.__name__, 'of stride={:d} and dilation={:d}'.format(stride, dilation))
...
class ResNet(nn.Module):
    def __init__(
        ...
        self.layer2 = self._make_layer(block, 128, layers[1], stride=2, dilate=stride_to_dilation[0])
